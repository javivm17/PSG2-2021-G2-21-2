...
public class OwnerController {
	...
	public ModelAndView showOwner(@PathVariable("ownerId") final int ownerId, final Principal principal) {
		final Owner owner = this.ownerService.findOwnerById(ownerId);
		final ModelAndView mav = new ModelAndView("owners/ownerDetails");
		mav.addObject(owner);
		final Integer pendingRequests = this.adoptionRequestService.getRequests(owner).size(); 
	...
	public String deleteOwner(@PathVariable("ownerId") final int ownerId, final Principal principal){
		try {
			final Owner owner = this.ownerService.findOwnerById(ownerId);
